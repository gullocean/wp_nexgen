...
function nexgen_data_handling( $form ){
	...
	if( $form['source'] == 'front-page-form' ){
		$source['wl_leadtype'] = SideQuote; // number represent "WEB-Nexgen"
        $data['wl_leadtype'] = SideQuote;
	} elseif( $form['source'] == 'full-page-form' ){
		$source['wl_leadtype'] = FullQuote;
        $data['wl_leadtype'] = FullQuote;
	} else {
		$source = null;
	}
