...
function nexgen_data_handling( $form ){
	...
	$data['wl_numhandset'] = (int)$form['busines_phone_handsets']; // not in sql?
							// foreach ($form['checkbox'] as $item) {
							// 	 switch ($item) {
							// 			 case "business_solution_1":
							// 					 $data['wl_typeofsol'] = 'Yes';
							// 					 break;
							// 			 case "business_solution_2":
							// 					 $data['wl_typeofsol'] = 'Yes';
							// 					 break;
							// 			 case "business_solution_3":
							// 					 $data['wl_typeofsol'] = 'Yes';
							// 					 break;
							// 			 case "business_solution_4":
							// 					 $data['wl_typeofsol'] = 'Yes';
							// 					 break;
							// 			 case "business_solution_5":
							// 					 $data['wl_typeofsol'] = 'Yes';
							// 					 break;
							// 			 case "business_solution_6":
							// 					 $data['wl_typeofsol'] = 'Yes';
							// 					 break;
							// 			 case "enquiry_reasons_1":
							// 					 $data['wl_reasonenq'] = 'Yes';
							// 					 break;
							// 		   case "enquiry_reasons_2":
			 			// 						 $data['wl_reasonenq'] = 'Yes';
			 			// 						 break;
							// 			 case "enquiry_reasons_3":
							// 					 $data['wl_reasonenq'] = 'Yes';
							// 					 break;
							// 			 case "enquiry_reasons_4":
			 			// 						 $data['wl_reasonenq'] = 'Yes';
			 			// 						 break;
							// 			 case "enquiry_reasons_5":
							//  						 $data['wl_reasonenq'] = 'Yes';
							//  						 break;
							// 			 case "enquiry_reasons_6":
							//  						 $data['wl_reasonenq'] = 'Yes';
							//  						 break;
			 			// 				 case "enquiry_reasons_7":
							//  			 			 $data['wl_reasonenq'] = 'Yes';
							//  			 			 break;
							// 			 case "newsletter":
							// 		 			 	 $data['wl_marketingper'] = 'Yes';
							// 		 			 	 break;
							//
							// 			 default:
							// 					 break;
...
// 		'enquiry_reasons_4', // 'Cost reductiong',
