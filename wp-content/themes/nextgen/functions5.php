...
function nexgen_data_handling( $form ){
	...
	if(isset($_COOKIE['uniqueid'])) { 							//also tried CampaignID
		...
		if ($form['enquiry_reasons_1']) {
			$data['wl_typeofsol'] = 'Expanding business';
		}
		if ($form['enquiry_reasons_2']) {
			$data['wl_typeofsol'] = 'Moving premises';
		}
		if ($form['enquiry_reasons_3']) {
			$data['wl_typeofsol'] = 'Get NBN ready';
		}
		if ($form['enquiry_reasons_4']) {
			$data['wl_typeofsol'] = 'Cost reduction';
		}
		if ($form['enquiry_reasons_5']) {
			$data['wl_typeofsol'] = 'Transition to PABX od VOIP';
		}
		if ($form['enquiry_reasons_6']) {
			$data['wl_typeofsol'] = 'Upgrading technology';
		}
		if ($form['enquiry_reasons_7']) {
			$data['wl_typeofsol'] = 'Trade-in/Cash-back';
		}
		if ($form['newsletter']) {
