    ...
    function get_settings_fields() {
        $settings_fields = array(
            ...
            'fw_settings_styling' => array(
                ...
                array(
                    'name' => 'buttoncolor',
                    'label' => __( 'Next Button Color', $this->_text_domain ),
                    'desc' => __( 'Choose a color for the Next Button', $this->_text_domain ),
                    'type' => 'color',
                    'default' => '#1d7071'
                ),
                array(
                    'name' => 'previouscolor',
                    'label' => __( 'Previous Button Color', $this->_text_domain ),
                    'desc' => __( 'Choose a color for the Prvious Button', $this->_text_domain ),
                    'type' => 'color',
                    'default' => '#b1b1b1'
                )
            ),
