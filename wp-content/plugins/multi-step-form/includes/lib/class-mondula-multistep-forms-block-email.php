...
class Mondula_Form_Wizard_Block_Email extends Mondula_Form_Wizard_Block {
    ...
    public function render( $ids ) { 
      ...
      <div class="fw-input-container">
          <h3><?php echo $this->_label ?></h3><input type="text" class="fw-text-input" data-id="email" name="<?php echo strtolower(preg_replace("/[^A-Za-z?!]/",'',$this->_label)); ?>"><span class="fa fa-envelope form-control-feedback" aria-hidden="true"></span>
      </div>
