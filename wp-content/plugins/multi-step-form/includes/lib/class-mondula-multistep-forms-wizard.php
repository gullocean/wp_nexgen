...
<div class="fw-progress-wrap">
    ...
    <ul class="fw-progress-bar"
        data-previouscolor="<?php echo $this->fw_get_option('previouscolor' ,'fw_settings_styling', '#aaa');?>"
        data-buttoncolor="<?php echo $this->fw_get_option('buttoncolor', 'fw_settings_styling', '#555');?>">
        <?php
        for ($i = 0; $i < $cnt; $i++) {
            $step = $this->_steps[$i];
            ?>
...
<?php
    ...
    public function render ( $wizardId ) {
        ...
        ob_start();
        ?>
        <div id="mondula-multistep-forms" class="fw-wizard" data-stepCount="<?php echo count( $this->_steps )?>" data-wizardid="<?php echo $wizardId ?>" data-redirect="<?php echo $this->_settings['thankyou']?>">
                ...
                <div class="fw-wizard-button-container">
                    <div class="fw-container">
                        <div class="fw-wizard-buttons">
                            <button class="fw-button-previous"></button>
                            <button class="fw-button-next btn-next"><?php _e( 'Next' ) ?></button>
