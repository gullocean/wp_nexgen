jQuery(document).ready(function(e) {
        ...
        function ae(a, r, n) {
            ...
            jQuery.each(fw_data, function(key, fw) {
            	if (fw.name == "email_address") {
            		api_param = "lp_Email";
            	} else if (fw.name == "post_code") {
            		api_param = "lp_Zip";
            	} else if (fw.name == "name") {
            		api_param = "lp_ContactName";
            	} else if (fw.name == "business_name") {
            		api_param = "lp_Company";
            	} else if (fw.name == "phone_number") {
            		api_param = "lp_Phone";
            	} else {
            		api_param = e('input[name=' + fw.name + ']:checked').data('api');
            	}

            	fw.api_param = api_param;
            });
